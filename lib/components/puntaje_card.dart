...
class _PuntajeCardState extends State<PuntajeCard> {
  Color _getPuntajeColor() {
    final puntaje = widget.puntuacion.puntaje;
    if (puntaje >= 800) return Colors.green;
    if (puntaje >= 600) return Colors.orange;
    if (puntaje >= 400) return Colors.yellow.shade700;
    return Colors.red;
  }

  String _getNivelTexto() {
    final puntaje = widget.puntuacion.puntaje;
    if (puntaje >= 800) return 'Excelente';
    if (puntaje >= 600) return 'Bueno';
    if (puntaje >= 400) return 'Regular';
          ...
          children: [
              ...
              children: [
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    value: widget.puntuacion.puntaje / 1000,
                    strokeWidth: 12,
            ...
            Row(
              ...
              children: [
                ...
                Text('1000', style: TextStyle(color: Colors.grey.shade600)),
              ],
            ),
          ],
        ),

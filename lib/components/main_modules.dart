...
import 'package:arequipagocreditos/screen/puntuacion_screen.dart';
import 'package:arequipagocreditos/screen/cupones_screen.dart';
                  ...
                  child: ModuleCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PuntuacionScreen(),
                        ),
                      );
                    },
                  ),
                  ...
                  child: ModuleCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const CuponesScreen(),
                        ),
                      );
                    },
                  ),
